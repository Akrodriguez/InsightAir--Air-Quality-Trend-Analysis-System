                    ...
                    {tabs.map((tab, index) => {
                        ...
                        return (
                            <motion.button
                                ...
                                className={`px-4 py-3 rounded-xl font-medium text-sm flex items-center gap-2 relative overflow-hidden ${isActive
                                        ? 'text-white'
                        ...
                        >
                            {models.map((model) => (
                                <button
                                    ...
                                    className={`w-full px-4 py-3 text-left text-sm transition-all duration-200 hover:bg-gray-700/50 ${selectedModel === model.value
                ...
                <div className="w-full px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-sm text-gray-400">
                            API Status:
                            <span className={`ml-2 px-3 py-1 rounded-full text-xs font-medium ${hz?.status === "ok"
