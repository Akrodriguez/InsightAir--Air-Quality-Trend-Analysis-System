...
ACCENT = os.getenv("InsightAir_ACCENT_HEX", "#22C55E")
...
def make_report(payload: ReportIn) -> bytes:
    ...
    # Header
    story.append(Paragraph("<para alignment='center'><b>InsightAir</b></para>", title_style))
    ...
    story.append(separator())
    story.append(Paragraph("<para alignment='center'>Generated by InsightAir</para>", normal_style))
